...
const EtatPaiements = () => {
  ...
  const filteredPaiements = (etatPaiements || []).filter(paiement =>
    paiement.libelle?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    paiement.code?.toLowerCase().includes(searchTerm.toLowerCase())
  );
          ...
          <Table stickyHeader>
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ bgcolor: 'primary.main', color: 'white', fontWeight: 600 }}>Libellé</TableCell>
                <TableCell sx={{ bgcolor: 'primary.main', color: 'white', fontWeight: 600 }}>Description</TableCell>
            ...
            <TableBody>
              {isLoading ? (
                ...
                filteredPaiements.map((paiement) => (
                  ...
                  >
                    <TableCell>
                      <Chip label={paiement.code} color="primary" size="small" />
                    </TableCell>
                    <TableCell>
